...
<div class="mb-3">
        ...
        <input type="text" name="About_us" id="Learn_About_Us" placeholder="Enter name" class="form-control">
    </div>
<!---Select Subject:--->    
<div class="mb-3">
        <label for="sel1">Select Subject:</label>
...
<div class="mb-3">
  ...
  <textarea name="message" id="not listed " required class="form-control" rows="3"></textarea>
</div>
   <!------Submit------->
  ...
  <section class="apply-now" id="apply" style="padding: 40px 0px;">
    <div class="container">
      <div class="col-lg-12">
        <div class="section-heading">
          <h2 style="text-align: center;">Our Students Review
          </h2>
        </div>
      </div>
